	...
	LOD 0
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				float temp_output_7_0_g20966 = _MainTexColorMinValue;
				float3 temp_cast_2 = (temp_output_7_0_g20966).xxx;
				float3 break1524_g20948 = saturate( saturate( ( ( (MainTex_RGBA587_g20948).rgb - temp_cast_2 ) / ( _MainTexColorMaxValue - temp_output_7_0_g20966 ) ) ) );
				half MainTex_R_Remap73_g20948 = break1524_g20948.x;
				half MainTex_G_Remap265_g20948 = break1524_g20948.y;
				float3 appendResult274_g20948 = (float3((MainTex_R_Remap73_g20948*2.0 + -1.0) , 0.0 , (MainTex_G_Remap265_g20948*2.0 + -1.0)));
				...
				float2 appendResult1347_g20948 = (float2(WorldPosition.x , WorldPosition.z));
				half Noise_Scale892_g20948 = _NoiseScaleValue;
				half2 Noise_Coords1409_g20948 = ( -( appendResult1347_g20948 * 0.1 ) * Noise_Scale892_g20948 );
				float2 temp_output_3_0_g20962 = Noise_Coords1409_g20948;
				float2 temp_output_21_0_g20962 = Direction_Advanced1454_g20948;
				half Noise_Speed898_g20948 = _NoiseSpeedValue;
				float temp_output_15_0_g20962 = ( _Time.y * Noise_Speed898_g20948 );
				float temp_output_23_0_g20962 = frac( temp_output_15_0_g20962 );
				float4 lerpResult39_g20962 = lerp( tex2D( _NoiseTex, ( temp_output_3_0_g20962 + ( temp_output_21_0_g20962 * temp_output_23_0_g20962 ) ) ) , tex2D( _NoiseTex, ( temp_output_3_0_g20962 + ( temp_output_21_0_g20962 * frac( ( temp_output_15_0_g20962 + 0.5 ) ) ) ) ) , ( abs( ( temp_output_23_0_g20962 - 0.5 ) ) / 0.5 ));
				half Noise_Min893_g20948 = _NoiseMinValue;
				float temp_output_7_0_g20963 = Noise_Min893_g20948;
				float4 temp_cast_5 = (temp_output_7_0_g20963).xxxx;
				half Noise_Max894_g20948 = _NoiseMaxValue;
				half2 Noise_Advanced1427_g20948 = (saturate( ( ( lerpResult39_g20962 - temp_cast_5 ) / ( Noise_Max894_g20948 - temp_output_7_0_g20963 ) ) )).rg;
				...
				float temp_output_7_0_g20965 = _MainTexAlphaMinValue;
				half MainTex_A_Remap74_g20948 = saturate( saturate( ( ( (MainTex_RGBA587_g20948).a - temp_output_7_0_g20965 ) / ( _MainTexAlphaMaxValue - temp_output_7_0_g20965 ) ) ) );
				half4 Colors37_g20953 = TVE_ColorsCoords;
				half4 Extras37_g20953 = TVE_ExtrasCoords;
				half4 Motion37_g20953 = TVE_MotionCoords;
				half4 Vertex37_g20953 = TVE_VertexCoords;
				half4 localIS_ELEMENT37_g20953 = IS_ELEMENT( Colors37_g20953 , Extras37_g20953 , Motion37_g20953 , Vertex37_g20953 );
				float4 temp_output_35_0_g20954 = localIS_ELEMENT37_g20953;
				float temp_output_7_0_g20959 = TVE_ElementsFadeValue;
				float2 temp_cast_6 = (temp_output_7_0_g20959).xx;
				float2 temp_output_846_0_g20948 = saturate( ( ( abs( (( (temp_output_35_0_g20954).zw + ( (temp_output_35_0_g20954).xy * (WorldPosition).xz ) )*2.002 + -1.001) ) - temp_cast_6 ) / ( 1.0 - temp_output_7_0_g20959 ) ) );
				float2 break852_g20948 = ( temp_output_846_0_g20948 * temp_output_846_0_g20948 );
				float lerpResult842_g20948 = lerp( 1.0 , ( 1.0 - saturate( ( break852_g20948.x + break852_g20948.y ) ) ) , _ElementVolumeFadeMode);
				half Fade_EdgeMask656_g20948 = lerpResult842_g20948;
				half Element_Intensity56_g20948 = ( _ElementIntensity * i.ase_color.a * Fade_EdgeMask656_g20948 * _RaycastFadeValue );
				half Final_MotionAdvanced_A1439_g20948 = ( MainTex_A_Remap74_g20948 * Element_Intensity56_g20948 );
...
Node;AmplifyShaderEditor.FunctionNode;177;-640,-1280;Inherit;False;Define Element Motion;71;;20879;6eebc31017d99e84e811285e6a5d199d;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;281;-640,-1024;Inherit;False;Base Element;2;;20948;0e972c73cae2ee54ea51acc9738801d0;5,477,2,478,0,145,3,481,2,491,1;0;1;FLOAT4;0
WireConnection;0;0;281;0
ASEEND*/
//CHKSM=E1C7422BE16C8A84A1B1347CA553A2437379332D