	...
	LOD 0
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half4 MainTex_RGBA587_g53317 = tex2D( _MainTex, ( ( ( 1.0 - i.ase_texcoord1.xy ) * (_MainUVs).xy ) + (_MainUVs).zw ) );
				float temp_output_7_0_g53335 = _MainTexColorMinValue;
				float3 temp_cast_0 = (temp_output_7_0_g53335).xxx;
				float3 break1524_g53317 = saturate( saturate( ( ( (MainTex_RGBA587_g53317).rgb - temp_cast_0 ) / ( _MainTexColorMaxValue - temp_output_7_0_g53335 ) ) ) );
				half MainTex_R_Remap73_g53317 = break1524_g53317.x;
				half Base_Extras_RGB213_g53317 = ( lerpResult181_g53317 * MainTex_R_Remap73_g53317 * i.ase_color.r );
				float3 appendResult1191_g53317 = (float3(1.0 , 0.0 , Base_Extras_RGB213_g53317));
				half3 Final_MotionPower_RGB1190_g53317 = appendResult1191_g53317;
				float temp_output_7_0_g53334 = _MainTexAlphaMinValue;
				half MainTex_A_Remap74_g53317 = saturate( saturate( ( ( (MainTex_RGBA587_g53317).a - temp_output_7_0_g53334 ) / ( _MainTexAlphaMaxValue - temp_output_7_0_g53334 ) ) ) );
				half4 Colors37_g53322 = TVE_ColorsCoords;
				half4 Extras37_g53322 = TVE_ExtrasCoords;
				half4 Motion37_g53322 = TVE_MotionCoords;
				half4 Vertex37_g53322 = TVE_VertexCoords;
				half4 localIS_ELEMENT37_g53322 = IS_ELEMENT( Colors37_g53322 , Extras37_g53322 , Motion37_g53322 , Vertex37_g53322 );
				float4 temp_output_35_0_g53323 = localIS_ELEMENT37_g53322;
				float temp_output_7_0_g53328 = TVE_ElementsFadeValue;
				float2 temp_cast_1 = (temp_output_7_0_g53328).xx;
				float2 temp_output_846_0_g53317 = saturate( ( ( abs( (( (temp_output_35_0_g53323).zw + ( (temp_output_35_0_g53323).xy * (WorldPosition).xz ) )*2.002 + -1.001) ) - temp_cast_1 ) / ( 1.0 - temp_output_7_0_g53328 ) ) );
				float2 break852_g53317 = ( temp_output_846_0_g53317 * temp_output_846_0_g53317 );
				...
				half Final_MotionControl_A523_g53317 = ( MainTex_A_Remap74_g53317 * Element_Intensity56_g53317 );
				float4 appendResult1193_g53317 = (float4(Final_MotionPower_RGB1190_g53317 , Final_MotionControl_A523_g53317));
				
				
				finalColor = appendResult1193_g53317;
				return finalColor;
			}
			ENDCG
		}
...
Node;AmplifyShaderEditor.FunctionNode;197;-640,-1024;Inherit;False;Base Element;2;;53317;0e972c73cae2ee54ea51acc9738801d0;5,477,2,478,0,145,3,481,0,491,1;0;1;FLOAT4;0
WireConnection;0;0;197;0
ASEEND*/
//CHKSM=B930D399D783FEE5CBE2F81326C127F7259169FB