	...
	LOD 0
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half4 MainTex_RGBA587_g22567 = tex2D( _MainTex, ( ( ( 1.0 - i.ase_texcoord1.xy ) * (_MainUVs).xy ) + (_MainUVs).zw ) );
				float temp_output_7_0_g22585 = _MainTexColorMinValue;
				float3 temp_cast_2 = (temp_output_7_0_g22585).xxx;
				float3 break1524_g22567 = saturate( saturate( ( ( (MainTex_RGBA587_g22567).rgb - temp_cast_2 ) / ( _MainTexColorMaxValue - temp_output_7_0_g22585 ) ) ) );
				half MainTex_R_Remap73_g22567 = break1524_g22567.x;
				half MainTex_G_Remap265_g22567 = break1524_g22567.y;
				float3 appendResult274_g22567 = (float3((MainTex_R_Remap73_g22567*2.0 + -1.0) , 0.0 , (MainTex_G_Remap265_g22567*2.0 + -1.0)));
				...
				float2 temp_output_3_0_g22581 = Noise_Coords1409_g22567;
				float2 temp_output_21_0_g22581 = Direction_Advanced1454_g22567;
				half Noise_Speed898_g22567 = _NoiseSpeedValue;
				float temp_output_15_0_g22581 = ( _Time.y * Noise_Speed898_g22567 );
				float temp_output_23_0_g22581 = frac( temp_output_15_0_g22581 );
				float4 lerpResult39_g22581 = lerp( tex2D( _NoiseTex, ( temp_output_3_0_g22581 + ( temp_output_21_0_g22581 * temp_output_23_0_g22581 ) ) ) , tex2D( _NoiseTex, ( temp_output_3_0_g22581 + ( temp_output_21_0_g22581 * frac( ( temp_output_15_0_g22581 + 0.5 ) ) ) ) ) , ( abs( ( temp_output_23_0_g22581 - 0.5 ) ) / 0.5 ));
				half Noise_Min893_g22567 = _NoiseMinValue;
				float temp_output_7_0_g22582 = Noise_Min893_g22567;
				float4 temp_cast_5 = (temp_output_7_0_g22582).xxxx;
				half Noise_Max894_g22567 = _NoiseMaxValue;
				half2 Noise_Advanced1427_g22567 = (saturate( ( ( lerpResult39_g22581 - temp_cast_5 ) / ( Noise_Max894_g22567 - temp_output_7_0_g22582 ) ) )).rg;
				...
				float temp_output_7_0_g22584 = _MainTexAlphaMinValue;
				half MainTex_A_Remap74_g22567 = saturate( saturate( ( ( (MainTex_RGBA587_g22567).a - temp_output_7_0_g22584 ) / ( _MainTexAlphaMaxValue - temp_output_7_0_g22584 ) ) ) );
				half4 Colors37_g22572 = TVE_ColorsCoords;
				half4 Extras37_g22572 = TVE_ExtrasCoords;
				half4 Motion37_g22572 = TVE_MotionCoords;
				half4 Vertex37_g22572 = TVE_VertexCoords;
				half4 localIS_ELEMENT37_g22572 = IS_ELEMENT( Colors37_g22572 , Extras37_g22572 , Motion37_g22572 , Vertex37_g22572 );
				float4 temp_output_35_0_g22573 = localIS_ELEMENT37_g22572;
				float temp_output_7_0_g22578 = TVE_ElementsFadeValue;
				float2 temp_cast_6 = (temp_output_7_0_g22578).xx;
				float2 temp_output_846_0_g22567 = saturate( ( ( abs( (( (temp_output_35_0_g22573).zw + ( (temp_output_35_0_g22573).xy * (WorldPosition).xz ) )*2.002 + -1.001) ) - temp_cast_6 ) / ( 1.0 - temp_output_7_0_g22578 ) ) );
				float2 break852_g22567 = ( temp_output_846_0_g22567 * temp_output_846_0_g22567 );
				...
				half Final_MotionAdvanced_A1439_g22567 = ( MainTex_A_Remap74_g22567 * Element_Intensity56_g22567 );
				float4 appendResult1463_g22567 = (float4(Final_MotionAdvanced_RGB1438_g22567 , Final_MotionAdvanced_A1439_g22567));
				half Element_EffectMotion946_g22567 = _ElementMotionMode;
				
				
				finalColor = ( appendResult1463_g22567 + ( Element_EffectMotion946_g22567 * 0.0 ) );
				return finalColor;
			}
			ENDCG
		}
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;0;-320,-1024;Float;False;True;-1;2;TVEShaderElementGUI;0;5;BOXOPHOBIC/The Vegetation Engine/Elements/Default/Motion Advanced;0770190933193b94aaa3065e307002fa;True;Unlit;0;0;Unlit;2;True;True;2;5;False;;10;False;;4;1;False;;1;False;;True;0;False;;0;False;;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;2;False;;True;True;True;True;True;True;0;True;_render_colormask;False;False;False;False;False;False;False;True;False;255;False;;255;False;;255;False;;7;False;;1;False;;1;False;;1;False;;7;False;;1;False;;1;False;;1;False;;False;True;2;False;;True;0;False;;True;False;0;False;;0;False;;True;4;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;PreviewType=Plane;DisableBatching=True=DisableBatching;True;5;False;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;0;;0;0;Standard;1;Vertex Position,InvertActionOnDeselection;1;0;0;1;True;False;;False;0
...
Node;AmplifyShaderEditor.FunctionNode;403;-639,-1024;Inherit;False;Base Element;2;;22567;0e972c73cae2ee54ea51acc9738801d0;5,477,2,478,0,145,3,481,2,491,1;0;1;FLOAT4;0
WireConnection;0;0;403;0
ASEEND*/
//CHKSM=0AE6B49E788F3F9DDD876ED3C000C1F4F7C6CDFB