	...
	LOD 0
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half4 MainTex_RGBA587_g18625 = tex2D( _MainTex, ( ( ( 1.0 - i.ase_texcoord1.xy ) * (_MainUVs).xy ) + (_MainUVs).zw ) );
				half temp_output_7_0_g20892 = _MainTexColorMinValue;
				half3 temp_cast_0 = (temp_output_7_0_g20892).xxx;
				half3 break1524_g18625 = saturate( saturate( ( ( (MainTex_RGBA587_g18625).rgb - temp_cast_0 ) / ( _MainTexColorMaxValue - temp_output_7_0_g20892 ) ) ) );
				half MainTex_R_Remap73_g18625 = break1524_g18625.x;
				half Base_Extras_RGB213_g18625 = ( lerpResult181_g18625 * MainTex_R_Remap73_g18625 * i.ase_color.r );
				half3 appendResult239_g18625 = (half3(0.0 , 0.0 , Base_Extras_RGB213_g18625));
				half3 Final_Overlay_RGB238_g18625 = appendResult239_g18625;
				half temp_output_7_0_g20891 = _MainTexAlphaMinValue;
				half MainTex_A_Remap74_g18625 = saturate( saturate( ( ( (MainTex_RGBA587_g18625).a - temp_output_7_0_g20891 ) / ( _MainTexAlphaMaxValue - temp_output_7_0_g20891 ) ) ) );
				...
				half2 temp_output_846_0_g18625 = saturate( ( ( abs( (( (temp_output_35_0_g20854).zw + ( (temp_output_35_0_g20854).xy * (WorldPosition).xz ) )*2.002 + -1.001) ) - temp_cast_1 ) / ( 1.0 - temp_output_7_0_g20862 ) ) );
				half2 break852_g18625 = ( temp_output_846_0_g18625 * temp_output_846_0_g18625 );
				...
				half Final_Overlay_A241_g18625 = ( MainTex_A_Remap74_g18625 * Element_Intensity56_g18625 );
...
/*ASEBEGIN
Version=19103
Node;AmplifyShaderEditor.FunctionNode;116;-640,-1152;Inherit;False;Base Element;2;;18625;0e972c73cae2ee54ea51acc9738801d0;5,477,1,478,0,145,2,481,0,491,1;0;1;FLOAT4;0
Node;AmplifyShaderEditor.FunctionNode;113;-640,-1408;Inherit;False;Define Element Extras;71;;20896;adca672cb6779794dba5f669b4c5f8e3;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;0;-304,-1152;Half;False;True;-1;2;TVEShaderElementGUI;0;5;BOXOPHOBIC/The Vegetation Engine/Elements/Default/Extras Overlay;0770190933193b94aaa3065e307002fa;True;Unlit;0;0;Unlit;2;False;True;2;5;False;;10;False;;0;1;False;;0;False;;True;0;False;;0;False;;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;2;False;;False;True;False;False;True;False;0;False;;False;False;False;False;False;False;False;True;False;255;False;;255;False;;255;False;;7;False;;1;False;;1;False;;1;False;;7;False;;1;False;;1;False;;1;False;;False;True;2;False;;True;0;False;;True;False;0;False;;0;False;;True;4;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;PreviewType=Plane;DisableBatching=True=DisableBatching;True;5;False;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;0;;0;0;Standard;1;Vertex Position,InvertActionOnDeselection;1;0;0;1;True;False;;False;0
...
ASEEND*/
//CHKSM=E93892BEFF244DFE8888364F2A8D3D46D119AD01