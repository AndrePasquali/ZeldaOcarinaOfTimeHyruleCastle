	...
	LOD 0
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half4 MainTex_RGBA587_g20498 = tex2D( _MainTex, ( ( ( 1.0 - i.ase_texcoord1.xy ) * (_MainUVs).xy ) + (_MainUVs).zw ) );
				float temp_output_7_0_g20892 = _MainTexColorMinValue;
				float3 temp_cast_0 = (temp_output_7_0_g20892).xxx;
				float3 break1524_g20498 = saturate( saturate( ( ( (MainTex_RGBA587_g20498).rgb - temp_cast_0 ) / ( _MainTexColorMaxValue - temp_output_7_0_g20892 ) ) ) );
				half MainTex_R_Remap73_g20498 = break1524_g20498.x;
				...
				float lerpResult413_g20498 = lerp( ( 1.0 - ( Value_Main157_g20498 * MainTex_R_Remap73_g20498 * i.ase_color.r ) ) , ( ( ( TVE_SeasonOptions_X50_g20498 * lerpResult419_g20498 ) + ( TVE_SeasonOptions_Y51_g20498 * lerpResult422_g20498 ) + ( TVE_SeasonOptions_Z52_g20498 * lerpResult407_g20498 ) + ( TVE_SeasonOptions_W53_g20498 * lerpResult415_g20498 ) ) * i.ase_color.r ) , Element_Mode55_g20498);
				half Base_Extras_A423_g20498 = ( 1.0 - lerpResult413_g20498 );
				float temp_output_7_0_g20891 = _MainTexAlphaMinValue;
				half MainTex_A_Remap74_g20498 = saturate( saturate( ( ( (MainTex_RGBA587_g20498).a - temp_output_7_0_g20891 ) / ( _MainTexAlphaMaxValue - temp_output_7_0_g20891 ) ) ) );
				float lerpResult224_g20498 = lerp( 1.0 , Base_Extras_A423_g20498 , MainTex_A_Remap74_g20498);
				...
				float2 temp_output_846_0_g20498 = saturate( ( ( abs( (( (temp_output_35_0_g20854).zw + ( (temp_output_35_0_g20854).xy * (WorldPosition).xz ) )*2.002 + -1.001) ) - temp_cast_1 ) / ( 1.0 - temp_output_7_0_g20862 ) ) );
				float2 break852_g20498 = ( temp_output_846_0_g20498 * temp_output_846_0_g20498 );
				...
				float lerpResult941_g20498 = lerp( lerpResult799_g20498 , ( Base_Extras_A423_g20498 * MainTex_A_Remap74_g20498 * Element_Intensity56_g20498 ) , Element_BlendA918_g20498);
...
Node;AmplifyShaderEditor.RangedFloatNode;133;-608,-1152;Inherit;False;Property;_render_dst;_render_dst;74;1;[HideInInspector];Create;True;0;0;0;True;0;False;0;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;132;-768,-1152;Inherit;False;Property;_render_src;_render_src;73;1;[HideInInspector];Create;True;0;0;0;True;0;False;2;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;131;-768,-1025;Inherit;False;Base Element;2;;20498;0e972c73cae2ee54ea51acc9738801d0;5,477,3,478,0,145,1,481,2,491,1;0;1;FLOAT4;0
...
ASEEND*/
//CHKSM=9CD6A09F8C07780598BDF7DCEC33AE1E329A64A9