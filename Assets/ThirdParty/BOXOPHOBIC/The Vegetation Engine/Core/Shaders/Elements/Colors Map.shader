	...
	LOD 0
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half3 Final_ColorsMap_RGB598_g20930 = (( Color_Main_RGBA49_g20930 * MainTex_RGBA587_g20930 )).rgb;
				half4 Colors37_g20935 = TVE_ColorsCoords;
				half4 Extras37_g20935 = TVE_ExtrasCoords;
				half4 Motion37_g20935 = TVE_MotionCoords;
				half4 Vertex37_g20935 = TVE_VertexCoords;
				half4 localIS_ELEMENT37_g20935 = IS_ELEMENT( Colors37_g20935 , Extras37_g20935 , Motion37_g20935 , Vertex37_g20935 );
				half4 temp_output_35_0_g20936 = localIS_ELEMENT37_g20935;
				half temp_output_7_0_g20941 = TVE_ElementsFadeValue;
				half2 temp_cast_0 = (temp_output_7_0_g20941).xx;
				half2 temp_output_846_0_g20930 = saturate( ( ( abs( (( (temp_output_35_0_g20936).zw + ( (temp_output_35_0_g20936).xy * (WorldPosition).xz ) )*2.002 + -1.001) ) - temp_cast_0 ) / ( 1.0 - temp_output_7_0_g20941 ) ) );
				half2 break852_g20930 = ( temp_output_846_0_g20930 * temp_output_846_0_g20930 );
				half lerpResult842_g20930 = lerp( 1.0 , ( 1.0 - saturate( ( break852_g20930.x + break852_g20930.y ) ) ) , _ElementVolumeFadeMode);
				half Fade_EdgeMask656_g20930 = lerpResult842_g20930;
				half Element_Intensity56_g20930 = ( _ElementIntensity * i.ase_color.a * Fade_EdgeMask656_g20930 * _RaycastFadeValue );
				half temp_output_7_0_g20947 = _MainTexAlphaMinValue;
				half MainTex_A_Remap74_g20930 = saturate( saturate( ( ( (MainTex_RGBA587_g20930).a - temp_output_7_0_g20947 ) / ( _MainTexAlphaMaxValue - temp_output_7_0_g20947 ) ) ) );
				...
				half Influence834_g20930 = ( ( TVE_SeasonOptions_X50_g20930 * lerpResult829_g20930 ) + ( TVE_SeasonOptions_Y51_g20930 * lerpResult833_g20930 ) + ( TVE_SeasonOptions_Z52_g20930 * lerpResult816_g20930 ) + ( TVE_SeasonOptions_W53_g20930 * lerpResult817_g20930 ) );
				half Final_ColorsMap_A603_g20930 = ( Element_Intensity56_g20930 * MainTex_A_Remap74_g20930 * Influence834_g20930 );
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;0;-304,-512;Half;False;True;-1;2;TVEShaderElementGUI;0;5;BOXOPHOBIC/The Vegetation Engine/Elements/Default/Colors Map;0770190933193b94aaa3065e307002fa;True;Unlit;0;0;Unlit;2;False;True;2;5;False;;10;False;;0;1;False;;0;False;;True;0;False;;0;False;;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;2;False;;True;True;True;True;True;True;0;False;_render_colormask;False;False;False;False;False;False;False;True;False;255;False;;255;False;;255;False;;7;False;;1;False;;1;False;;1;False;;7;False;;1;False;;1;False;;1;False;;False;True;2;False;;True;0;False;;True;False;0;False;;0;False;;True;4;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;PreviewType=Plane;DisableBatching=True=DisableBatching;True;5;False;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;0;;0;0;Standard;1;Vertex Position,InvertActionOnDeselection;1;0;0;1;True;False;;False;0
...
Node;AmplifyShaderEditor.FunctionNode;151;-640,-512;Inherit;False;Base Element;2;;20930;0e972c73cae2ee54ea51acc9738801d0;5,477,0,478,1,145,0,481,0,491,1;0;1;FLOAT4;0
...
ASEEND*/
//CHKSM=331F55B15B81CD899B57D967CDC7C9DA8E0835E0