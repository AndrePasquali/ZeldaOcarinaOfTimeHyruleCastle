	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				half3 Input_Position419_g75769 = WorldPosition3905_g75660;
				...
				float2 temp_output_447_0_g75682 = ((TVE_MotionParams).xy*2.0 + -1.0);
				half2 Global_Wind_DirectionWS4683_g75660 = temp_output_447_0_g75682;
				half2 Input_DirectionWS423_g75769 = Global_Wind_DirectionWS4683_g75660;
				...
				float3 localObjectPosition_UNITY_MATRIX_M14_g75672 = ObjectPosition_UNITY_MATRIX_M();
				float3 appendResult60_g75678 = (float3(inputMesh.ase_texcoord3.x , inputMesh.ase_texcoord3.z , inputMesh.ase_texcoord3.y));
				half3 Mesh_PivotsData2831_g75660 = ( appendResult60_g75678 * _VertexPivotMode );
				float3 temp_output_122_0_g75672 = Mesh_PivotsData2831_g75660;
				float3 PivotsOnly105_g75672 = (mul( GetObjectToWorldMatrix(), float4( temp_output_122_0_g75672 , 0.0 ) ).xyz).xyz;
				#ifdef SHADEROPTIONS_CAMERA_RELATIVE_RENDERING
				float3 staticSwitch13_g75672 = ( ( localObjectPosition_UNITY_MATRIX_M14_g75672 + PivotsOnly105_g75672 ) + _WorldSpaceCameraPos );
				#else
				float3 staticSwitch13_g75672 = ( localObjectPosition_UNITY_MATRIX_M14_g75672 + PivotsOnly105_g75672 );
				#endif
				half3 ObjectData20_g75673 = staticSwitch13_g75672;
				half3 WorldData19_g75673 = ase_worldPos;
				#ifdef TVE_FEATURE_BATCHING
				float3 staticSwitch14_g75673 = WorldData19_g75673;
				#else
				float3 staticSwitch14_g75673 = ObjectData20_g75673;
				#endif
				float3 temp_output_114_0_g75672 = staticSwitch14_g75673;
				float3 vertexToFrag4224_g75660 = temp_output_114_0_g75672;
				half3 ObjectData20_g75671 = vertexToFrag4224_g75660;
				half3 WorldData19_g75671 = vertexToFrag3890_g75660;
				#ifdef TVE_FEATURE_BATCHING
				float3 staticSwitch14_g75671 = WorldData19_g75671;
				#else
				float3 staticSwitch14_g75671 = ObjectData20_g75671;
				#endif
				float3 ObjectPosition4223_g75660 = staticSwitch14_g75671;
				float3 break111_g75859 = ObjectPosition4223_g75660;
				half Global_DynamicMode5112_g75660 = _VertexDynamicMode;
				half Input_DynamicMode120_g75859 = Global_DynamicMode5112_g75660;
				...
				half Input_Variation124_g75859 = Mesh_Variation16_g75660;
				...
				float Global_MeshVariation5104_g75660 = clampResult129_g75859;
				half Input_GlobalMeshVariation569_g75769 = Global_MeshVariation5104_g75660;
				...
				#endif
				float Global_ObjectVariation6217_g75660 = staticSwitch14_g75862;
				half Input_GlobalObjectVariation692_g75769 = Global_ObjectVariation6217_g75660;
				...
				half2 Global_Noise_OS5548_g75660 = (( mul( GetWorldToObjectMatrix(), float4( appendResult649_g75769 , 0.0 ) ).xyz * ase_parentObjectScale )).xz;
				half2 Input_Noise_DirectionOS487_g75927 = Global_Noise_OS5548_g75660;
				float2 break448_g75682 = temp_output_447_0_g75682;
				float3 appendResult452_g75682 = (float3(break448_g75682.x , 0.0 , break448_g75682.y));
				half2 Global_Wind_DirectionOS5692_g75660 = (( mul( GetWorldToObjectMatrix(), float4( appendResult452_g75682 , 0.0 ) ).xyz * ase_parentObjectScale )).xz;
				half2 Input_Wind_DirectionOS458_g75927 = Global_Wind_DirectionOS5692_g75660;
				float temp_output_84_0_g75889 = _LayerMotionValue;
				float4 temp_output_91_19_g75889 = TVE_MotionCoords;
				half2 UV94_g75889 = ( (temp_output_91_19_g75889).zw + ( (temp_output_91_19_g75889).xy * (ObjectPosition4223_g75660).xz ) );
				...
				half4 Global_Motion_Params3909_g75660 = ifLocalVar18_g75893;
				float4 break322_g75682 = Global_Motion_Params3909_g75660;
				half Global_Wind_Power2223_g75660 = break322_g75682.z;
				half Input_WindPower449_g75927 = Global_Wind_Power2223_g75660;
				...
				half Input_MeshHeight388_g75927 = Mesh_Height1524_g75660;
				...
				float Bounds_Height5230_g75660 = break63_g75853.x;
				half Input_BoundsHeight390_g75927 = Bounds_Height5230_g75660;
				...
				half Input_BendingAmplitude376_g75927 = Motion_10_Amplitude2258_g75660;
				float2 appendResult433_g75682 = (float2(break322_g75682.x , break322_g75682.y));
				float2 temp_output_436_0_g75682 = (appendResult433_g75682*2.0 + -1.0);
				float2 break441_g75682 = temp_output_436_0_g75682;
				float3 appendResult440_g75682 = (float3(break441_g75682.x , 0.0 , break441_g75682.y));
				half2 Global_React_DirectionOS39_g75660 = (( mul( GetWorldToObjectMatrix(), float4( appendResult440_g75682 , 0.0 ) ).xyz * ase_parentObjectScale )).xz;
				half2 Input_React_DirectionOS358_g75927 = Global_React_DirectionOS39_g75660;
				...
				half Global_Interaction_Mask66_g75660 = ( break322_g75682.w * break322_g75682.w * break322_g75682.w * break322_g75682.w );
				float Input_InteractionGlobalMask330_g75927 = Global_Interaction_Mask66_g75660;
				...
				half Motion_10_BendingZ190_g75660 = break364_g75927.y;
				half Angle44_g75662 = Motion_10_BendingZ190_g75660;
				half3 VertexPos40_g75668 = ( VertexPosRotationAxis50_g75662 + ( VertexPosOtherAxis82_g75662 * cos( Angle44_g75662 ) ) + ( cross( float3(1,0,0) , VertexPosOtherAxis82_g75662 ) * sin( Angle44_g75662 ) ) );
				float3 appendResult74_g75668 = (float3(0.0 , 0.0 , VertexPos40_g75668.z));
				half3 VertexPosRotationAxis50_g75668 = appendResult74_g75668;
				float3 break84_g75668 = VertexPos40_g75668;
				float3 appendResult81_g75668 = (float3(break84_g75668.x , break84_g75668.y , 0.0));
				half3 VertexPosOtherAxis82_g75668 = appendResult81_g75668;
				half Motion_10_BendingX216_g75660 = break364_g75927.x;
				half Angle44_g75668 = -Motion_10_BendingX216_g75660;
				...
				half Input_GlobalVariation400_g75817 = Global_MeshVariation5104_g75660;
				...
				half3 Input_Position419_g75686 = VertexPosition3588_g75660;
				float3 normalizeResult518_g75686 = normalize( Input_Position419_g75686 );
				half2 Input_DirectionOS423_g75686 = Global_React_DirectionOS39_g75660;
				float2 break521_g75686 = -Input_DirectionOS423_g75686;
				float3 appendResult522_g75686 = (float3(break521_g75686.x , 0.0 , break521_g75686.y));
				float dotResult519_g75686 = dot( normalizeResult518_g75686 , appendResult522_g75686 );
				half Input_Mask62_g75686 = _MotionFacingValue;
				float lerpResult524_g75686 = lerp( 1.0 , (dotResult519_g75686*0.5 + 0.5) , Input_Mask62_g75686);
				half ObjectData20_g75687 = max( lerpResult524_g75686 , 0.001 );
				half WorldData19_g75687 = 1.0;
				#ifdef TVE_FEATURE_BATCHING
				float staticSwitch14_g75687 = WorldData19_g75687;
				#else
				float staticSwitch14_g75687 = ObjectData20_g75687;
				#endif
				half Motion_FacingMask5214_g75660 = staticSwitch14_g75687;
				half Motion_20_Amplitude4381_g75660 = ( _MotionValue_20 * Motion_FacingMask5214_g75660 );
				half Input_MotionAmplitude384_g75817 = Motion_20_Amplitude4381_g75660;
				half Input_GlobalWind407_g75817 = Global_Wind_Power2223_g75660;
				float4 break638_g75769 = abs( lerpResult590_g75769 );
				half Global_Noise_B5526_g75660 = break638_g75769.b;
				half Input_GlobalNoise411_g75817 = Global_Noise_B5526_g75660;
				...
				half Mesh_Motion_2060_g75660 = break61_g75853.x;
				half Input_MeshMotion_20388_g75817 = Mesh_Motion_2060_g75660;
				float Bounds_Radius5231_g75660 = break63_g75853.y;
				half Input_BoundsRadius390_g75817 = Bounds_Radius5231_g75660;
				half2 Input_DirectionOS366_g75817 = Global_React_DirectionOS39_g75660;
				...
				half3 Motion_20_Squash4418_g75660 = ( ( (max( Motion_20_SineA450_g75817 , Motion_20_SineB395_g75817 )*0.2 + 1.0) * Final_MotionAmplitude418_g75817 * Input_Squash58_g75817 * Input_MeshMotion_20388_g75817 * Input_BoundsRadius390_g75817 ) * appendResult372_g75817 );
				half3 VertexPos40_g75661 = ( ( VertexPosRotationAxis50_g75668 + ( VertexPosOtherAxis82_g75668 * cos( Angle44_g75668 ) ) + ( cross( float3(0,0,1) , VertexPosOtherAxis82_g75668 ) * sin( Angle44_g75668 ) ) ) + Motion_20_Squash4418_g75660 );
				...
				half Motion_20_Rolling5257_g75660 = ( Motion_20_SineA450_g75817 * Final_MotionAmplitude418_g75817 * Input_Rolling379_g75817 * Input_MeshMotion_20388_g75817 );
				half Angle44_g75661 = Motion_20_Rolling5257_g75660;
				float2 appendResult461_g75810 = (float2(ase_worldPos.x , ase_worldPos.z));
				half Input_MotionScale321_g75810 = _MotionScale_32;
				half Input_MotionVariation330_g75810 = _MotionVariation_32;
				half Input_GlobalVariation372_g75810 = Global_MeshVariation5104_g75660;
				half Input_MotionSpeed62_g75810 = _MotionSpeed_32;
				half Global_Speed350_g75810 = TVE_FlutterParams.y;
				float4 tex2DNode460_g75810 = SAMPLE_TEXTURE2D_LOD( TVE_NoiseTex, sampler_Linear_Repeat, ( ( appendResult461_g75810 * Input_MotionScale321_g75810 * 0.03 ) + ( Input_MotionVariation330_g75810 * Input_GlobalVariation372_g75810 ) + ( _TimeParameters.x * Input_MotionSpeed62_g75810 * Global_Speed350_g75810 * 0.02 ) ), 0.0 );
				float3 appendResult462_g75810 = (float3(tex2DNode460_g75810.r , tex2DNode460_g75810.g , tex2DNode460_g75810.b));
				float temp_output_7_0_g75915 = TVE_MotionFadeEnd;
				half Motion_FadeOut4005_g75660 = saturate( ( ( distance( ase_worldPos , _WorldSpaceCameraPos ) - temp_output_7_0_g75915 ) / ( ( TVE_MotionFadeStart - temp_output_7_0_g75915 ) + 0.01 ) ) );
				...
				half Input_MotionAmplitude58_g75810 = Motion_30_Amplitude4960_g75660;
				half Global_Power354_g75810 = TVE_FlutterParams.x;
				half Mesh_Motion_30144_g75660 = break61_g75853.y;
				half Input_MeshMotion_30374_g75810 = Mesh_Motion_30144_g75660;
				half Input_GlobalWind471_g75810 = Global_Wind_Power2223_g75660;
				half Input_GlobalNoise472_g75810 = Global_Noise_B5526_g75660;
				float lerpResult466_g75810 = lerp( 2.0 , 0.6 , Input_GlobalWind471_g75810);
				half3 Motion_30_Details263_g75660 = ( (appendResult462_g75810*2.0 + -1.0) * Input_MotionAmplitude58_g75810 * Global_Power354_g75810 * Input_MeshMotion_30374_g75810 * Input_GlobalWind471_g75810 * pow( Input_GlobalNoise472_g75810 , lerpResult466_g75810 ) );
				...
				half2 UV97_g75894 = ( (temp_output_94_19_g75894).zw + ( (temp_output_94_19_g75894).xy * (ObjectPosition4223_g75660).xz ) );
				...
				half4 Global_Vertex_Params4173_g75660 = ifLocalVar18_g75898;
				...
				half3 ObjectData20_g75669 = appendResult3480_g75660;
				half3 _Vector11 = half3(1,1,1);
				half3 WorldData19_g75669 = _Vector11;
				#ifdef TVE_FEATURE_BATCHING
				float3 staticSwitch14_g75669 = WorldData19_g75669;
				#else
				float3 staticSwitch14_g75669 = ObjectData20_g75669;
				#endif
				half3 Vertex_Size1741_g75660 = staticSwitch14_g75669;
				half3 _Vector5 = half3(1,1,1);
				float3 Vertex_SizeFade1740_g75660 = _Vector5;
				float3 lerpResult16_g75881 = lerp( VertexPosition3588_g75660 , ( ( ( staticSwitch4976_g75660 + Grass_Perspective2661_g75660 ) * Vertex_Size1741_g75660 * Vertex_SizeFade1740_g75660 ) + Mesh_PivotsOS2291_g75660 ) , TVE_Enabled);
				float3 Final_VertexPosition890_g75660 = ( lerpResult16_g75881 + _DisableSRPBatcher );
				
				outputPackedVaryingsMeshToPS.ase_texcoord6.xyz = vertexToFrag3890_g75660;
						...
						)
			{
				...
				half Gradient_Tint2784_g75660 = saturate( ( ( Mesh_Height1524_g75660 - temp_output_7_0_g75797 ) / ( ( _GradientMaxValue - temp_output_7_0_g75797 ) + 0.01 ) ) );
				float3 lerpResult2779_g75660 = lerp( (_GradientColorTwo).rgb , (_GradientColorOne).rgb , Gradient_Tint2784_g75660);
				...
				half Main_Mask_Remap5765_g75660 = saturate( ( ( clampResult5814_g75660 - temp_output_7_0_g75795 ) / ( ( _MainMaskMaxValue - temp_output_7_0_g75795 ) + 0.01 ) ) );
				half Blend_Mask_Remap6621_g75660 = Main_Mask_Remap5765_g75660;
				half Gradient_Mask6207_g75660 = Blend_Mask_Remap6621_g75660;
				...
				half Occlusion_Mask6432_g75660 = saturate( ( ( clampResult6091_g75660 - temp_output_7_0_g75800 ) / ( ( _VertexOcclusionMaxValue - temp_output_7_0_g75800 ) + 0.01 ) ) );
				float3 lerpResult2945_g75660 = lerp( (_VertexOcclusionColor).rgb , float3( 1,1,1 ) , Occlusion_Mask6432_g75660);
				half3 Occlusion_Color648_g75660 = lerpResult2945_g75660;
				half3 Blend_Albedo_Tinted2808_g75660 = ( Blend_Albedo265_g75660 * Blend_Albedo_Gradient5769_g75660 * Blend_Albedo_Noise5770_g75660 * Occlusion_Color648_g75660 );
				...
				float3 temp_cast_0 = (Blend_Albedo_Grayscale5939_g75660).xxx;
				float temp_output_82_0_g75909 = _LayerColorsValue;
				float4 temp_output_91_19_g75909 = TVE_ColorsCoords;
				float3 vertexToFrag3890_g75660 = packedInput.ase_texcoord6.xyz;
				float3 WorldPosition3905_g75660 = vertexToFrag3890_g75660;
				...
				half2 UV94_g75909 = ( (temp_output_91_19_g75909).zw + ( (temp_output_91_19_g75909).xy * (lerpResult4822_g75660).xz ) );
				...
				half4 Global_Colors_Params5434_g75660 = ifLocalVar18_g75913;
				float4 temp_output_346_0_g75688 = Global_Colors_Params5434_g75660;
				half Global_Colors_A1701_g75660 = saturate( (temp_output_346_0_g75688).w );
				...
				float3 lerpResult3618_g75660 = lerp( Blend_Albedo_Tinted2808_g75660 , temp_cast_0 , ( 1.0 - ( temp_output_6306_0_g75660 * temp_output_6306_0_g75660 ) ));
				half3 Global_Colors_RGB1700_g75660 = (temp_output_346_0_g75688).xyz;
				half3 Colors_RGB1954_g75660 = ( Global_Colors_RGB1700_g75660 * 4.594794 );
				half Colors_Value3692_g75660 = ( Blend_Mask_Remap6621_g75660 * _GlobalColors );
				float3 break111_g75859 = ObjectPosition4223_g75660;
				half Global_DynamicMode5112_g75660 = _VertexDynamicMode;
				half Input_DynamicMode120_g75859 = Global_DynamicMode5112_g75660;
				float Postion_Sum142_g75859 = ( ( break111_g75859.x + break111_g75859.y + break111_g75859.z + 0.001271 ) * ( 1.0 - Input_DynamicMode120_g75859 ) );
				...
				half Occlusion_Alpha6463_g75660 = _VertexOcclusionColor.a;
				float lerpResult6459_g75660 = lerp( Occlusion_Mask6432_g75660 , ( 1.0 - Occlusion_Mask6432_g75660 ) , _ColorsMaskMode);
				float lerpResult6461_g75660 = lerp( Occlusion_Alpha6463_g75660 , 1.0 , lerpResult6459_g75660);
				half Occlusion_Colors6450_g75660 = lerpResult6461_g75660;
				float dotResult6416_g75660 = dot( ( Blend_Albedo265_g75660 * Blend_Albedo_Gradient5769_g75660 * Blend_Albedo_Noise5770_g75660 ) , float3(0.2126,0.7152,0.0722) );
				half Blend_Albedo_Globals6410_g75660 = dotResult6416_g75660;
				float temp_output_7_0_g75826 = 0.1;
				float lerpResult16_g75720 = lerp( 0.0 , saturate( ( ( ( Colors_Value3692_g75660 * Colors_Influence3668_g75660 * Colors_Variation3650_g75660 * Occlusion_Colors6450_g75660 * saturate( ( Blend_Albedo_Globals6410_g75660 * 5.0 ) ) ) - temp_output_7_0_g75826 ) / ( ( 0.2 - temp_output_7_0_g75826 ) + 0.01 ) ) ) , TVE_Enabled);
				float3 lerpResult3628_g75660 = lerp( Blend_Albedo_Tinted2808_g75660 , ( lerpResult3618_g75660 * Colors_RGB1954_g75660 ) , lerpResult16_g75720);
				...
				half2 UV96_g75904 = ( (temp_output_93_19_g75904).zw + ( (temp_output_93_19_g75904).xy * (lerpResult4827_g75660).xz ) );
				...
				half4 Global_Extras_Params5440_g75660 = ifLocalVar18_g75908;
				float4 break456_g75748 = Global_Extras_Params5440_g75660;
				half Global_Extras_Overlay156_g75660 = break456_g75748.z;
				...
				half Overlay_Value5738_g75660 = ( _GlobalOverlay * Global_Extras_Overlay156_g75660 * Overlay_Variation4560_g75660 );
				...
				half Overlay_Shading6688_g75660 = saturate( ( Blend_Albedo_Globals6410_g75660 * 5.0 ) );
				half Overlay_Custom6707_g75660 = 1.0;
				float lerpResult6467_g75660 = lerp( Occlusion_Alpha6463_g75660 , 1.0 , Occlusion_Mask6432_g75660);
				half Occlusion_Overlay6471_g75660 = lerpResult6467_g75660;
				float temp_output_7_0_g75888 = 0.1;
				half Overlay_Mask_High6064_g75660 = saturate( ( ( ( Overlay_Value5738_g75660 * Overlay_Projection6081_g75660 * Overlay_Shading6688_g75660 * Overlay_Custom6707_g75660 * Occlusion_Overlay6471_g75660 ) - temp_output_7_0_g75888 ) / ( ( 0.2 - temp_output_7_0_g75888 ) + 0.01 ) ) );
				half Overlay_Mask269_g75660 = Overlay_Mask_High6064_g75660;
				float3 lerpResult336_g75660 = lerp( Blend_Albedo_Colored863_g75660 , Global_OverlayColor1758_g75660 , Overlay_Mask269_g75660);
				half3 Blend_Albedo_Overlay359_g75660 = lerpResult336_g75660;
				half Global_WetnessContrast6502_g75660 = TVE_WetnessContrast;
				half Global_Extras_Wetness305_g75660 = break456_g75748.y;
				half Wetness_Value6343_g75660 = ( Global_Extras_Wetness305_g75660 * _GlobalWetness );
				float3 lerpResult6367_g75660 = lerp( Blend_Albedo_Overlay359_g75660 , ( Blend_Albedo_Overlay359_g75660 * Blend_Albedo_Overlay359_g75660 ) , ( Global_WetnessContrast6502_g75660 * Wetness_Value6343_g75660 ));
				half3 Blend_Albedo_Wetness6351_g75660 = lerpResult6367_g75660;
				float3 _Vector10 = float3(1,1,1);
				half3 Blend_Albedo_Highlight5771_g75660 = _Vector10;
				float3 temp_output_6309_0_g75660 = ( Blend_Albedo_Wetness6351_g75660 * Blend_Albedo_Highlight5771_g75660 );
				half3 Subsurface_Color1722_g75660 = ( (_SubsurfaceColor).rgb * Blend_Albedo_Wetness6351_g75660 );
				half Global_Subsurface4041_g75660 = TVE_SubsurfaceValue;
				float temp_output_6120_0_g75660 = ( 1.0 - Overlay_Value5738_g75660 );
				half Subsurface_Intensity1752_g75660 = ( _SubsurfaceValue * Global_Subsurface4041_g75660 * ( temp_output_6120_0_g75660 * temp_output_6120_0_g75660 ) );
				half Subsurface_Mask1557_g75660 = Blend_Mask_Remap6621_g75660;
				...
				half3 Blend_Albedo_Subsurface149_g75660 = ( temp_output_6309_0_g75660 + Subsurface_Approximation1693_g75660 );
				
				half4 packed34_g75830 = SAMPLE_TEXTURE2D( _MainNormalTex, sampler_Linear_Repeat, Main_UVs15_g75660 );
				half2 localNormalUnpack34_g75830 = NormalUnpack( packed34_g75830 );
				half2 Main_Normal137_g75660 = ( localNormalUnpack34_g75830 * _MainNormalValue );
				half2 Blend_Normal312_g75660 = Main_Normal137_g75660;
				half Global_OverlayNormalScale6581_g75660 = TVE_OverlayNormalValue;
				float lerpResult6585_g75660 = lerp( 1.0 , Global_OverlayNormalScale6581_g75660 , Overlay_Mask269_g75660);
				half2 Blend_Normal_Overlay366_g75660 = ( Blend_Normal312_g75660 * lerpResult6585_g75660 );
				half Global_WetnessNormalScale6571_g75660 = TVE_WetnessNormalValue;
				float lerpResult6579_g75660 = lerp( 1.0 , Global_WetnessNormalScale6571_g75660 , ( Wetness_Value6343_g75660 * Wetness_Value6343_g75660 ));
				half2 Blend_Normal_Wetness6372_g75660 = ( Blend_Normal_Overlay366_g75660 * lerpResult6579_g75660 );
				float3 appendResult6568_g75660 = (float3(Blend_Normal_Wetness6372_g75660 , 1.0));
				float3 temp_output_13_0_g75855 = appendResult6568_g75660;
				...
				float3 temp_cast_8 = (( 0.04 * Render_Specular4861_g75660 )).xxx;
				...
				half Global_Extras_Emissive4203_g75660 = break456_g75748.x;
				...
				half Blend_Smoothness_Overlay371_g75660 = lerpResult343_g75660;
				float temp_output_6499_0_g75660 = ( 1.0 - Wetness_Value6343_g75660 );
				half Blend_Smoothness_Wetness4130_g75660 = saturate( ( Blend_Smoothness_Overlay371_g75660 + ( 1.0 - ( temp_output_6499_0_g75660 * temp_output_6499_0_g75660 ) ) ) );
				...
				half Global_Extras_Alpha1033_g75660 = saturate( break456_g75748.w );
				float lerpResult5154_g75660 = lerp( 0.0 , Global_MeshVariation5104_g75660 , _AlphaVariationValue);
				half Global_Alpha_Variation5158_g75660 = lerpResult5154_g75660;
				half AlphaTreshold2132_g75660 = _AlphaClipValue;
				half Blend_Mask_Invert6260_g75660 = 1.0;
				...
				float lerpResult16_g75730 = lerp( 1.0 , lerpResult5203_g75660 , TVE_Enabled);
				half Global_Alpha315_g75660 = lerpResult16_g75730;
				...
				float lerpResult3993_g75660 = lerp( 1.0 , saturate( ( dotResult3851_g75660 * 3.0 ) ) , _FadeGlancingValue);
				half Fade_Glancing3853_g75660 = lerpResult3993_g75660;
				half Fade_Effects_A5360_g75660 = Fade_Glancing3853_g75660;
				float temp_output_7_0_g75798 = TVE_CameraFadeMin;
				float lerpResult4755_g75660 = lerp( 1.0 , saturate( saturate( ( ( distance( ase_worldPos , _WorldSpaceCameraPos ) - temp_output_7_0_g75798 ) / ( ( TVE_CameraFadeMax - temp_output_7_0_g75798 ) + 0.01 ) ) ) ) , _FadeCameraValue);
				half Fade_Camera3743_g75660 = lerpResult4755_g75660;
				half Fade_Effects_B6228_g75660 = ( ( Fade_Effects_A5360_g75660 * Fade_Camera3743_g75660 ) * ( 1.0 - _FadeConstantValue ) );
				float temp_output_5865_0_g75660 = saturate( ( ( Fade_Effects_B6228_g75660 - SAMPLE_TEXTURE3D( TVE_NoiseTex3D, sampler_Linear_Repeat, ( TVE_NoiseTex3DTilling * WorldPosition3905_g75660 ) ).r ) + AlphaTreshold2132_g75660 ) );
				half Fade_Mask5149_g75660 = ( 1.0 * Blend_Mask_Invert6260_g75660 );
				float lerpResult5141_g75660 = lerp( 1.0 , temp_output_5865_0_g75660 , Fade_Mask5149_g75660);
				half Fade_Alpha3727_g75660 = lerpResult5141_g75660;
				float temp_output_6678_0_g75660 = min( ( Blend_Alpha6157_g75660 * Global_Alpha315_g75660 ) , Fade_Alpha3727_g75660 );
				half Alpha34_g75873 = temp_output_6678_0_g75660;
				float temp_output_3_0_g75868 = Alpha34_g75873;
				float Alpha19_g75868 = temp_output_3_0_g75868;
				float temp_output_15_0_g75868 = AlphaTreshold2132_g75660;
				...
				half Final_Alpha914_g75660 = saturate( ( Alpha19_g75868 * Blend_Color_Alpha6167_g75660 ) );
				
				surfaceDescription.BaseColor = Blend_Albedo_Subsurface149_g75660;
				...
				surfaceDescription.Smoothness = Blend_Smoothness_Wetness4130_g75660;
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh  )
			{
				...
				half Input_MotionVariation284_g75769 = _MotionVariation_10;
				float3 localObjectPosition_UNITY_MATRIX_M14_g75672 = ObjectPosition_UNITY_MATRIX_M();
				float3 appendResult60_g75678 = (float3(inputMesh.uv3.x , inputMesh.uv3.z , inputMesh.uv3.y));
				half3 Mesh_PivotsData2831_g75660 = ( appendResult60_g75678 * _VertexPivotMode );
				float3 temp_output_122_0_g75672 = Mesh_PivotsData2831_g75660;
				float3 PivotsOnly105_g75672 = (mul( GetObjectToWorldMatrix(), float4( temp_output_122_0_g75672 , 0.0 ) ).xyz).xyz;
				#ifdef SHADEROPTIONS_CAMERA_RELATIVE_RENDERING
				...
				outputPackedVaryingsMeshToPS.ase_texcoord3.xyz = vertexToFrag3890_g75660;
				outputPackedVaryingsMeshToPS.ase_texcoord4.xyz = vertexToFrag4224_g75660;
				float3 ase_worldNormal = TransformObjectToWorldNormal(inputMesh.normalOS);
				float3 vertexToFrag5058_g75660 = ase_worldNormal;
				outputPackedVaryingsMeshToPS.ase_texcoord5.xyz = vertexToFrag5058_g75660;
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				half Overlay_Variation4560_g75660 = lerpResult1065_g75660;
				half Overlay_Value5738_g75660 = ( _GlobalOverlay * Global_Extras_Overlay156_g75660 * Overlay_Variation4560_g75660 );
				float3 vertexToFrag5058_g75660 = packedInput.ase_texcoord5.xyz;
				half3 World_Normal4101_g75660 = vertexToFrag5058_g75660;
				float lerpResult5730_g75660 = lerp( (World_Normal4101_g75660).y , packedInput.ase_normal.y , Global_DynamicMode5112_g75660);
				float lerpResult5885_g75660 = lerp( 0.4 , 1.0 , saturate( lerpResult5730_g75660 ));
				half Overlay_Projection6081_g75660 = lerpResult5885_g75660;
		...
		Pass
		{
			...
			AttributesMesh ApplyMeshModification(AttributesMesh inputMesh, float3 timeParameters, inout PackedVaryingsMeshToPS outputPackedVaryingsMeshToPS )
			{
				...
				outputPackedVaryingsMeshToPS.ase_texcoord8.xyz = vertexToFrag3890_g75660;
						...
						)
			{
				...
				float temp_output_82_0_g75909 = _LayerColorsValue;
				float4 temp_output_91_19_g75909 = TVE_ColorsCoords;
				float3 vertexToFrag3890_g75660 = packedInput.ase_texcoord8.xyz;
				float3 WorldPosition3905_g75660 = vertexToFrag3890_g75660;
...
Node;AmplifyShaderEditor.RangedFloatNode;168;-2176,-896;Half;False;Property;_IsLeafShader;_IsLeafShader;202;1;[HideInInspector];Create;True;0;0;0;True;0;False;1;0;1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;81;-1984,-896;Half;False;Property;_IsStandardShader;_IsStandardShader;203;1;[HideInInspector];Create;True;0;0;0;True;0;False;1;0;1;1;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=40A5B5B93CCC914F63DD68BA4F67B30B3EB940D0
